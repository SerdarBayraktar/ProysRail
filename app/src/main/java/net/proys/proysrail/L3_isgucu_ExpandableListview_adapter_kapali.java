...
public class L3_isgucu_ExpandableListview_adapter_kapali extends BaseExpandableListAdapter {
    ...
    public L3_isgucu_ExpandableListview_adapter_kapali(Context context, List<String> list,List<String> listPuantaj, HashMap<String, List<String>> listHashMap,HashMap<String, List<String>> listHashMapPuantaj) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView ==null){
            ...
            convertView = inflater.inflate(R.layout.l3_isgucu_row_group_kapali,null);
